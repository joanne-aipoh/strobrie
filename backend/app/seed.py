...
PRODUCTS = [
    ...
    ("pil", "Coffee", "Pistachio Latte", 6500),
    ...
    ("bit", "Tea", "Berry Iced Tea", 5300),
    ("lit", "Tea", "Lemon Iced Tea", 4700),
    ("spit", "Tea", "Sweet Peach Iced Tea", 5500),
    ("gait", "Tea", "Green Apple Iced Tea", 5500),
    ...
    # --- Milkshakes ---
    ("vms", "Milkshakes", "Vanilla Milkshake", 6600),
    ("bnm", "Milkshakes", "Banana Milkshake", 7200),
    ("orm", "Milkshakes", "Oreo Milkshake", 7600),
    ("lbm", "Milkshakes", "Lotus Biscoff Milkshake", 7400),
    ("cfm", "Milkshakes", "Coffee Milkshake", 7600),
    ("brm", "Milkshakes", "Brownie Milkshake", 7200),
    ("ptm", "Milkshakes", "Pistachio Milkshake", 8000),
    ("swm", "Milkshakes", "Strawberry Milkshake", 7000),
    ("cpm", "Milkshakes", "Caramel Popcorn Milkshake", 7500),
    # --- Lemonades ---
    ("frl", "Lemonades", "Fresh Lemonade", 5100),
    ("spl", "Lemonades", "Sparkling Lemonade", 4800),
    ("orgl", "Lemonades", "Orange Lemonade", 5800),
    ("blul", "Lemonades", "Blueberry Lemonade", 6600),
    ("pfl", "Lemonades", "Passion Fruit Lemonade", 6600),
    ("sbl", "Lemonades", "Strawberry Basil Lemonade", 5800),
    ("cpfl", "Lemonades", "Cucumber Passion Fruit Lemonade", 5800),
    ("mml", "Lemonades", "Mango Mint Lemonade (Seasonal)", 5800),
    ("lycl", "Lemonades", "Lychee Lemonade", 5500),
    ("cherl", "Lemonades", "Cherry Lemonade (Alc)", 6500),
    # --- Breakfast ---
    ("bph", "Breakfast", "Butter Pancakes (Half Stack)", 5500),
    ("bpf", "Breakfast", "Butter Pancakes (Full Stack)", 7500),
    ("cph", "Breakfast", "Chocolate Pancakes (Half Stack)", 6400),
    ("cpf", "Breakfast", "Chocolate Pancakes (Full Stack)", 8800),
    ("blph", "Breakfast", "Blueberry Pancakes (Half Stack)", 6500),
    ("blpf", "Breakfast", "Blueberry Pancakes (Full Stack)", 8700),
    ("ccph", "Breakfast", "Chocolate Chip Pancakes (Half Stack)", 6200),
    ("ccpf", "Breakfast", "Chocolate Chip Pancakes (Full Stack)", 8600),
    ("nph", "Breakfast", "Nutella Pancakes (Half Stack)", 6400),
    ("npf", "Breakfast", "Nutella Pancakes (Full Stack)", 8800),
    ("fth", "Breakfast", "French Toast (Half)", 5500),
    ("ftf", "Breakfast", "French Toast (Full)", 7000),
    ("vbth", "Breakfast", "Very Berry Toast (Half)", 6500),
    ("vbtf", "Breakfast", "Very Berry Toast (Full)", 8500),
    ("nfth", "Breakfast", "Nutella French Toast (Half)", 6000),
    ("nftf", "Breakfast", "Nutella French Toast (Full)", 8000),
    ("eggb", "Breakfast", "Eggs Breakfast (Scrambled/Fried/Poached/Sunny Side Up)", 6200),
    ("omc", "Breakfast", "Omelette With Cheese", 7600),
    ("omm", "Breakfast", "Omelette With Mushroom", 8500),
    ("omcm", "Breakfast", "Omelette With Cheese & Mushroom", 9500),
    ("savb", "Breakfast", "Savoury Breakfast", 8500),
    ("engb", "Breakfast", "English Breakfast", 12500),
    ("thsand", "Breakfast", "Turkey Ham Sandwich", 8000),
    ("chsand", "Breakfast", "Chicken Sandwich", 8500),
    ("tcsand", "Breakfast", "Tomato Cheese Sandwich", 8500),
    ("bltsand", "Breakfast", "BLT Sandwich", 8500),
    ("bmuf", "Breakfast", "Breakfast Muffin", 8000),
    ("bburg", "Breakfast", "Breakfast Burger", 10500),
    ("xegg", "Breakfast", "Extra Eggs [2]", 2600),
    ...
    # --- Bakery ---
    ("cup1", "Bakery", "Cupcake (Single)", 2400),
    ("cup4", "Bakery", "Cupcake (Box of 4)", 8500),
    ("cup6", "Bakery", "Cupcake (Box of 6)", 13100),
    ("cup8", "Bakery", "Cupcake (Box of 8)", 17200),
    ("cup12", "Bakery", "Cupcake (Box of 12)", 25800),
    ("cup24", "Bakery", "Cupcake (Box of 24)", 49200),
    ("lcs", "Bakery", "Lemon Cake Slice", 4200),
    ("bcs", "Bakery", "Banana Cake Slice", 4200),
    ("ccs", "Bakery", "Carrot Cake Slice", 4700),
    ("rvs", "Bakery", "Red Velvet Slice", 4200),
    ("mcs", "Bakery", "Milk Chocolate Slice", 4800),
    ("cncs", "Bakery", "Cookies and Cream Slice", 4800),
    ...
    ("ctlb", "Bakery", "Cake Tub – Lotus Biscoff", 7600),
    ("ctvb", "Bakery", "Cake Tub – Very Berry Vanilla", 7600),
    ("ctde", "Bakery", "Cake Tub – Dark Choco Espresso", 7300),
    ("cthc", "Bakery", "Cake Tub – Hazelnut Crunch", 8000),
    ("ctcc", "Bakery", "Cake Tub – Coconut Cream Trifle", 7200),
    ("mcny", "Bakery", "Mini Cheesecake – New York Style", 6200),
    ("mcbl", "Bakery", "Mini Cheesecake – Blueberry", 7000),
    ("mcst", "Bakery", "Mini Cheesecake – Strawberries", 6900),
    ("mcor", "Bakery", "Mini Cheesecake – Oreo", 6900),
    ("mcmg", "Bakery", "Mini Cheesecake – Mango (Seasonal)", 6800),
    ("mclb", "Bakery", "Mini Cheesecake – Lotus Biscoff", 6900),
    ...
    ("muf1", "Bakery", "Muffin (Single)", 2900),
    ("muf4", "Bakery", "Muffin (Box of 4)", 10000),
    ("muf6", "Bakery", "Muffin (Box of 6)", 15500),
    ("muf12", "Bakery", "Muffin (Box of 12)", 30000),
    ("bwc1", "Bakery", "Chocolate Brownie (Single)", 2200),
    ("bwc4", "Bakery", "Chocolate Brownie (Box of 4)", 8000),
    ("bwo1", "Bakery", "Oreo Brownie (Single)", 2800),
    ("bwo4", "Bakery", "Oreo Brownie (Box of 4)", 10500),
    ("bwr1", "Bakery", "Red Velvet Brownie (Single)", 3000),
    ("bwr4", "Bakery", "Red Velvet Brownie (Box of 4)", 10800),
    ...
    ("brstp1", "Bakery", "Sticky Toffee Pecan Roll (Single)", 2800),
    ("brstp4", "Bakery", "Sticky Toffee Pecan Roll (Box of 4)", 10500),
    ("brcin1", "Bakery", "Cinnamon Roll (Single)", 2200),
    ("brcin4", "Bakery", "Cinnamon Roll (Box of 4)", 8400),
    ("crob", "Bakery", "Butter Croissant (Fridays only)", 4800),
    ("crpac", "Bakery", "Pain Au Chocolat Croissant (Fridays only)", 4800),
    ("cralm", "Bakery", "Almond Croissant (Fridays only)", 5000),
    ("crhc", "Bakery", "Ham & Cheese Croissant (Fridays only)", 5500),
    ("scpl", "Bakery", "Plain Scones (Box of 4, preorder)", 8000),
    ("scrs", "Bakery", "Raisin Scones (Box of 4, preorder)", 9000),
    ("sccr", "Bakery", "Cranberry Scones (Box of 4, preorder)", 9800),
    ("eccho", "Bakery", "Chocolate Eclairs (Box of 6, preorder)", 25000),
    ("echaz", "Bakery", "Hazelnut Eclairs (Box of 6, preorder)", 29000),
    ("ecpis", "Bakery", "Pistachio Eclairs (Box of 6, preorder)", 29000),
